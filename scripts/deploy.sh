...
dotnet publish -c Release -r ${osx_x64} -o $TRAVIS_BUILD_DIR/releases/Stardew.MPSaveEditor-${osx_x64}
...
zip -r $TRAVIS_BUILD_DIR/releases/Stardew.MPSaveEditor-$TRAVIS_BUILD_ID-${osx_x64}.zip ./Stardew.MPSaveEditor-${osx_x64}
